...
This would be a mistake, as they suffer from all of the problems of 
any automated procedure for model selection [e.g., @berk2013valid; @lee2016exact]. 
And note that:
...
With these caveats in mind, these methods can be used for explicit data mining or prediction.
