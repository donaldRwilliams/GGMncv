...
3. <span id="f3"></span>  It is possible to compute confidence intervals for lasso with the methods included in the **SILGGM** `R` package. These do not use the bootstrap [@zhang2018silggm]   
[(return)](#a3).
