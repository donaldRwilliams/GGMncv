...
using it for model *selection* is not necessarily ideal. There are various ways to remove the false positives, including thresholding after model selection [i.e., removing small relations, @loh2012structure] 
