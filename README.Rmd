...
## Bootstrapping
It might be tempting to perform a bootstrap and then construct confidence intervals for the edges. However, in general, these "confidence" intervals do not have the correct properties to be considered
...
Thus, at this time, confidence intervals are not provided confidence intervals for the partial correlations. However, **GGMncv** does included the so-called variable inclusion "probability" for each relation [see p 1523 in @bunea2011penalized; and Figure 6.7 in @hastie2015statistical]. These are computed using a non-paramametric boostrap strategy.
