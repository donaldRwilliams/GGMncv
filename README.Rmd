...
to overcome the various limitations of lasso, including (but not limited to) inconsistent model selection, biased^[Note that the penalties in **GGMncv** should be *nearly* unbiased] estimates, and a high false positive rate.
