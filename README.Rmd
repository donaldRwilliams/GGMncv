...
For this reason, it is common to **not** provide standard errors (and thus confidence intervals) for penalized models <span id="a2">[[2]](#f2)</span>. **GGMncv** follows the idea of behind the **penalized** `R` package:
