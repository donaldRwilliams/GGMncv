...
The above essentially takes the selected graph, and the re-estimates it
with the constraint that the negative edges are actually zero. Perhaps a more 
...
bics <- NA
Thetas <- list()
for(i in seq_len(length(sol_path))){
