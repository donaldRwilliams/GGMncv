...
estimator. It is important to note that any function can be used, so long
as it return the inverse **correlation** matrix.
...
Perhaps a more trick situation is where the covariance matrix
